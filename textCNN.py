...
if __name__ == "__main__":
    ...
    #最好写绝对路径
    glove_dir = '/data/yanghan/homework/glove.6B/glove.6B.'+str(parse.embedding_dim)+'d.txt'
    word2vec_dir = '/data/yanghan/homework/glove.6B/glove.6B.word2vec.'+str(parse.embedding_dim)+'d.txt'
